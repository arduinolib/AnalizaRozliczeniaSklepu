...
{
        LoadGridFromFile("ListaArtSpozywczych.roz", StringGrid1);
        ...
        StringGrid1->Cells[3][0]="Ost.Cena det.";
}
//---------------------------------------------------------------------------
void __fastcall TForm4::Button6Click(TObject *Sender)
{

        SaveGridToFile("ListaArtSpozywczych.roz", (StringGrid1), false);
...
void __fastcall TForm4::Button1Click(TObject *Sender)
{
  ...
  return;
        ...
        Form6-> Edit10->Text=StringGrid1->Cells[3][StringGrid1->Row];
         Form6->ShowModal();
         }
        if(Edit2->Text=="1")
         {
